...
public class MainTest {
    ...
    @Test
    public void whenOneRThenReturnOneR() throws Exception {
        byte[] inputBytes = { 13 };
        byte[] expectedBytes = { 13 };
        assertArrayEquals(expectedBytes, doTest(inputBytes));
    }

    @Test
    public void whenOneNThenReturnOneN() throws Exception {
        byte[] inputBytes = { 10 };
    ...
    @Test
    public void whenOneZThenReturnOneZ() throws Exception {
        byte[] inputBytes = { 90 };
        byte[] expectedBytes = { 90 };
        assertArrayEquals(expectedBytes, doTest(inputBytes));
    }
